...
class ModuleDutchLanguagePackController extends BaseController
{
    ...
    public function indexAction(): void
    {
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-dutch-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-dutch-language-pack-progress.js", true);
    ...
    public function soundsAction(): void
    {
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-dutch-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-dutch-language-pack-sounds-index.js", true);
