...
namespace Modules\ModuleDutchLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Dutch Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Dutch UI translations from Messages/nl/ directory
 * - Dutch voice prompts from Sounds/nl-nl/ directory
 *
 ...
 *
 * @package Modules\ModuleDutchLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleDutchLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Dutch packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Dutch Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        ...
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Dutch Language Pack installed successfully (16 translation files, 642 sound files)',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        ...
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Dutch Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        ...
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Dutch Language Pack uninstalled successfully',
            LOG_INFO
        );
