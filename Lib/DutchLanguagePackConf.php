...
namespace Modules\ModuleDutchLanguagePack\Lib;

use MikoPBX\Modules\Config\ConfigClass;
use Modules\ModuleDutchLanguagePack\Lib\RestAPI\Controllers\SoundsController;

/**
 * DutchLanguagePackConf
 *
 * Wires the per-module REST endpoints (sounds inventory + conversion progress).
 */
class DutchLanguagePackConf extends ConfigClass
{
    public const string ROUTE_PREFIX = '/pbxcore/api/v3/module-dutch-language-pack';
